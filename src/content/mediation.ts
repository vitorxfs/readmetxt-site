...
const mediation: MediationContent = {
  ...
  title: 'CIPM e CDPO/BR - IAPP | Founder da Ston Digital - Consultoria em Privacidade e Proteção de Dados | Advogada | Graduada em Segurança da Informação',
  description: 'Profissional empreendedora com dupla formação (jurídica e técnica) e vivência internacional, com experiência na assessoria a empresas de setores variados em temas de privacidade, proteção de dados e segurança da informação. Apaixonada por livros e café.',
